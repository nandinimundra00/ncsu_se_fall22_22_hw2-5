...
class Data:
    ...
    def __init__(self, misc, src) -> None:
        '''
        Checks if the recived file name (variable src) is a string. 
        ...
        ----------
        src : input file name
        misc : to get the `the` configuration variable
        '''
        self.cols = None
        '''column class single object....no list here unlike rows....see next line :)'''
        self.rows = []
        '''storing Rows class objects'''
        self.misc = misc
        '''storing the miscUtils object'''
        self._the = misc.the
        '''setting the `the` coonfiguration variable'''
